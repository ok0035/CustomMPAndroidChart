...
public abstract class Chart<T extends ChartData<? extends IDataSet<? extends Entry>>> extends
    ...
    public boolean valuesToHighlight() {
        return mIndicesToHighlight == null || mIndicesToHighlight.size() <= 0
                || mIndicesToHighlight == null ? false
                : true;
    }
    ...
    public void moveNextHighlight() {
        ...
        try {
            Log.d("mChartTouchListener.getLastHighlighted().size()", mChartTouchListener.getLastHighlighted().size() + "");
        ...
        if (high == null)
            ...
            if (e == null) {
                ...
                if (mIndicesToHighlight == null) {
                    mIndicesToHighlight = new ArrayList<Highlight>();
                    mIndicesToHighlight.add(high);
                } else {
                    Log.d("mIndicator", "Length : " + mIndicesToHighlight.size());
                    Log.d("idx", "Length : " + idx);

                    if (idx < mIndicesToHighlight.size())
...
//            Log.e(LOG_TAG, "getHighlight!!! TEST");
...
//        Log.d("mIndicesToHighlight", "mIndicesToHighlight.length : " + mIndicesToHighlight.size());
        for (int i = 0; i < mIndicesToHighlight.size(); i++) {
            ...
            Entry e = mData.getEntryForHighlight(mIndicesToHighlight.get(i));
...
//            Log.d("mMarkerPosition", "X : " + pos[0] + " Y : " + pos[1]);
